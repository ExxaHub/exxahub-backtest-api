...
describe("standardDeviationOfReturn", () => {
    it("should calculate standard deviation for a valid window", () => {
        const returns = [
        ...
        const result = standardDeviationOfReturn(returns, { window: 3 });
    ...
    it("should throw an error for a window less than 2", () => {
        ...
        expect(() => standardDeviationOfReturn(returns, { window: 1 })).toThrow("Not enough data to calculate standard deviation of return for a window of 1.");
    });
    ...
    it("should throw an error for insufficient data", () => {
        ...
        expect(() => standardDeviationOfReturn(returns, { window: 2 })).toThrow("Not enough data to calculate standard deviation of return for a window of 2.");
    });
    ...
    it("should handle an exact window size", () => {
        ...
        const result = standardDeviationOfReturn(returns, { window: 2 });
        expect(result).toEqual({

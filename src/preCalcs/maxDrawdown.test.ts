...
describe("maxDrawdown", () => {
    it("should calculate max drawdown for a valid window", () => {
        const returns = [
        ...
        const result = maxDrawdown(returns, { window: 3 });
    ...
    it("should throw an error for a window less than 2", () => {
        ...
        expect(() => maxDrawdown(returns, { window: 1 })).toThrow("Not enough data to calculate max drawdown for a window of 1.");
    });
    ...
    it("should throw an error for insufficient data", () => {
        ...
        expect(() => maxDrawdown(returns, { window: 2 })).toThrow("Not enough data to calculate max drawdown for a window of 2.");
    });
    ...
    it("should handle an exact window size", () => {
        ...
        const result = maxDrawdown(returns, { window: 2 });
        expect(result).toEqual({
